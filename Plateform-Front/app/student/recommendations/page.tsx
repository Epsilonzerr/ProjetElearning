...
export default function StudentRecommendations() {
  ...
  const recommendations = {
    ...
    resources: [
      ...
      },
      {
        ...
        descriptionEn:
          "An explanatory video on the different forms of polymorphism in Java with concrete examples.",
        url: "#",
        priority: "Moyenne",
        priorityEn: "Medium",
      },
      {
        ...
        description:
          "Une série d'exercices pour maîtriser les design patterns qui utilisent le polymorphisme.",
        descriptionEn:
          "A series of exercises to master design patterns that use polymorphism.",
        url: "#",
        priority: "Élevée",
        priorityEn: "High",
      },
      {
        ...
        sourceEn: "Tech Blog",
        description:
          "Un article détaillé sur les techniques d'optimisation des algorithmes courants en Java.",
        descriptionEn:
          "A detailed article on optimization techniques for common algorithms in Java.",
        url: "#",
        priority: "Moyenne",
        priorityEn: "Medium",
      },
      {
        ...
        description:
          "Un atelier interactif pour approfondir vos connaissances sur les structures de données avancées.",
        descriptionEn:
          "An interactive workshop to deepen your knowledge of advanced data structures.",
        url: "#",
        priority: "Basse",
        priorityEn: "Low",
      },
  ...
  const getPriorityColorClass = (priority) => {
    const priorityText =
      language === "en" ? priority.priorityEn : priority.priority;
  ...
  const getResourceTypeIcon = (type) => {
    ...
    if (resourceType === "video" || resourceType === "vidéo") {
      ...
      resourceType === "pratique" ||
      resourceType === "exercices"
    ) {
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-8">
            <div>
              ...
              <p className="text-muted-foreground">
                {t("resources_tailored_to_profile")}
              </p>
            </div>
          </div>
                    ...
                    <div>
                      <CardHeader className="pb-2">
                        <div className="flex justify-between items-start">
                          ...
                          {/* <span
                            className={`text-xs px-2 py-1 rounded-full ${getPriorityColorClass(
                              resource
                            )}`}
                          >
                            {language === "en"
