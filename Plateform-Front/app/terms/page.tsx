      ...
      <main className="flex-1 container py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose dark:prose-invert max-w-none">
            ...
            <p className="dark:text-gray-300">
              {language === "fr"
                ? "La Plateforme est un outil d'évaluation en ligne destiné aux établissements d'enseignement, permettant aux professeurs de créer et gérer des évaluations, et aux étudiants de participer à ces évaluations."
                : "The Platform is an online assessment tool intended for educational institutions, allowing professors to create and manage assessments, and students to participate in these assessments."}
            </p>

            <h2 className="dark:text-white">{language === "fr" ? "3. Comptes utilisateurs" : "3. User Accounts"}</h2>
            <p className="dark:text-gray-300">
              {language === "fr"
            ...
            <p className="dark:text-gray-300">
              {language === "fr"
                ...
                : "All content and functionality on the Platform are the property of the Institut supérieur du Génie Appliqué and are protected by intellectual property laws. You may not reproduce, distribute, modify, or create derivative works from this content without explicit permission."}
            </p>

            <h2 className="dark:text-white">{language === "fr" ? "6. Confidentialité" : "6. Privacy"}</h2>
            <p className="dark:text-gray-300">
              {language === "fr"
            ...
            <h2 className="dark:text-white">
              {language === "fr" ? "7. Limitation de responsabilité" : "7. Limitation of Liability"}
            </h2>
            <p className="dark:text-gray-300">
              {language === "fr"
                ? 'La Plateforme est fournie "telle quelle" sans garantie d\'aucune sorte. Dans toute la mesure permise par la loi, nous déclinons toute responsabilité pour les dommages directs, indirects, accessoires, spéciaux ou consécutifs résultant de votre utilisation de la Plateforme.'
                : 'The Platform is provided "as is" without warranty of any kind. To the fullest extent permitted by law, we disclaim all liability for direct, indirect, incidental, special, or consequential damages resulting from your use of the Platform.'}
            </p>
            ...
            <h2 className="dark:text-white">{language === "fr" ? "9. Loi applicable" : "9. Governing Law"}</h2>
            <p className="dark:text-gray-300">
              {language === "fr"
            ...
            <h2 className="dark:text-white">{language === "fr" ? "10. Contact" : "10. Contact"}</h2>
            <p className="dark:text-gray-300">
              {language === "fr"
